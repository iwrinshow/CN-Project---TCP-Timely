...
private:
  double m_alpha;                  //!< EMWA parameter
  double m_beta;                   //!< Multiplicative decrement factor
  double m_delta;                  //!< Additive increment step
  ...
  double m_thigh;                       //!< Thigh
  double m_tlow;                        //!< Tlow
  double m_rate;                        //!< rate
  Time m_prevRtt;                     //!< Previous RTT
  double m_rttDiff;                     //!< Difference in RTT  
  double new_rtt;                       //!< New_RTT 
  uint32_t m_compEvents;                //!< Completion Events              
};
